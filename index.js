...
client.on("interactionCreate", async (interaction) => {
  if (interaction.isModalSubmit()) {
    ...
    const color = decision === "تم القبول" ? acceptedColor : rejectedColor;
    ...
    if (user) {
      user.send({ content: `تم الرد على اقتراحك بـ ${decision}` });
    }
  }
});
...
const TOKEN = "MTIwMTQ2NzMxNjk3ODg0NzgwNg.GhwbXi.7zLElG7caGKc292RYRc_zmL0enxzpbc3ALCWb4";
